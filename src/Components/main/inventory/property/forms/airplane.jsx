...
export const AirPlane = () => {
    ...
    const fetchDataName = async () => {
            const response = await fetch(`${Url}/api/airplane/${formik.values.code}`, {
                 headers: {
    ...
    const putHandlerAutoIncrement = async () => {
           await axios.put(
            `${Url}/api/autoincrementproperty/1/`,
              {
              airplane_01: form.office === 'دفتر مرکزی' ? form.autoIncrement.airplane_01+1 : form.autoIncrement.airplane_01,
              airplane_02: form.office === 'چابهار' ? form.autoIncrement.airplane_02+1 : form.autoIncrement.airplane_02,
              airplane_03: form.office === 'دزفول' ? form.autoIncrement.airplane_03+1 : form.autoIncrement.airplane_03,
              airplane_04: form.office === 'جاسک' ? form.autoIncrement.airplane_04+1 : form.autoIncrement.airplane_04,
              airplane_05: form.office === 'بیشه کلا' ? form.autoIncrement.airplane_05+1 : form.autoIncrement.airplane_05,
              airplane_06: form.office === 'اورهال تهران' ? form.autoIncrement.airplane_06+1 : form.autoIncrement.airplane_06,
              airplane_07: form.office === 'اورهال اصفهان' ? form.autoIncrement.airplane_07+1 : form.autoIncrement.airplane_07,
         }, {
                 headers: {
                  'Authorization': 'Bearer ' + localStorage.getItem('access_token'),
                }
    ...
    const handleAutoIncrement = () => {
            if (form.office === 'دفتر مرکزی') {
                return form.autoIncrement.airplane_01
            } else if (form.office === 'چابهار') {
                return form.autoIncrement.airplane_02
            } else if (form.office === 'دزفول') {
                return form.autoIncrement.airplane_03
            } else if (form.office === 'جاسک') {
                return form.autoIncrement.airplane_04
            } else if (form.office === 'بیشه کلا') {
                return form.autoIncrement.airplane_05
            } else if (form.office === 'اورهال تهران') {
                return form.autoIncrement.airplane_06
            } else if (form.office === 'اورهال اصفهان') {
                return form.autoIncrement.airplane_07
            }
    }
                               ...
                               <Fragment>
                                     <div className="col form-floating mb-3">
                                        <input type="text" className="form-control" id="nameCar" name='name' disabled={form.viewOnly} autoComplete='off'
                                            ...
                                            <label htmlFor="nameCar">نام هواپیما</label>
                                         <div className="invalid-feedback">
                                             نام هواپیما را وارد کنید.
                                         </div>
                                     </div>
                                     <div className="col form-floating mb-3">
