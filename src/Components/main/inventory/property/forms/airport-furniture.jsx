...
export const AirportFurniture = () => {
    ...
    const putHandlerAutoIncrement = async () => {
           await axios.put(
            `${Url}/api/autoincrementproperty/1/`,
              {
              airport_furniture_01: form.office === 'دفتر مرکزی' ? form.autoIncrement.airport_furniture_01+1 : form.autoIncrement.airport_furniture_01,
              airport_furniture_02: form.office === 'چابهار' ? form.autoIncrement.airport_furniture_02+1 : form.autoIncrement.airport_furniture_02,
              airport_furniture_03: form.office === 'دزفول' ? form.autoIncrement.airport_furniture_03+1 : form.autoIncrement.airport_furniture_03,
              airport_furniture_04: form.office === 'جاسک' ? form.autoIncrement.airport_furniture_04+1 : form.autoIncrement.airport_furniture_04,
              airport_furniture_05: form.office === 'بیشه کلا' ? form.autoIncrement.airport_furniture_05+1 : form.autoIncrement.airport_furniture_05,
              airport_furniture_06: form.office === 'اورهال تهران' ? form.autoIncrement.airport_furniture_06+1 : form.autoIncrement.airport_furniture_06,
              airport_furniture_07: form.office === 'اورهال اصفهان' ? form.autoIncrement.airport_furniture_07+1 : form.autoIncrement.airport_furniture_07,
         }, {
                 headers: {
                  'Authorization': 'Bearer ' + localStorage.getItem('access_token'),
                }
    ...
    const postHandlerRepair = async () => {
           await axios.post(
            `${Url}/api/repairedairportfurniture/`,
              {
              airport_furniture: formik.values.code,
              name: getName.name,
              document_code: formik.values.document_code,
              systemID: handleAutoIncrementFactor(),
    ...
    const handleAutoIncrement = () => {
        if (form.office === 'دفتر مرکزی') {
            return form.autoIncrement.airport_furniture_01
        } else if (form.office === 'چابهار') {
            return form.autoIncrement.airport_furniture_02
        } else if (form.office === 'دزفول') {
            return form.autoIncrement.airport_furniture_03
        } else if (form.office === 'جاسک') {
            return form.autoIncrement.airport_furniture_04
        } else if (form.office === 'بیشه کلا') {
            return form.autoIncrement.airport_furniture_05
        } else if (form.office === 'اورهال تهران') {
            return form.autoIncrement.airport_furniture_06
        } else if (form.office === 'اورهال اصفهان') {
            return form.autoIncrement.airport_furniture_07
        }
    }
